...
public class ListaDeProdutos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Lista de Produtos  - DemandaFácil 1.0");
        setResizable(false);
    ...
    private void btn_visualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_visualizarActionPerformed
        if(tbl_produtos.getSelectedRow() != -1){
            ...
            JOptionPane.showMessageDialog(null, "Nenhuma empresa selecionada! Selecione um produto para prosseguir.", "Erro Seleção Produto", JOptionPane.ERROR_MESSAGE);
        }
