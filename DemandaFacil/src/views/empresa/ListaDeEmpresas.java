...
public class ListaDeEmpresas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Lista de Empresas - DemandaFácil 1.0");
        setResizable(false);
    ...
    private void btn_visualizar_empresaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_visualizar_empresaActionPerformed
        if(tbl_empresas.getSelectedRow() != -1){
            ...
            JOptionPane.showMessageDialog(null, "Nenhuma empresa selecionada! Selecione uma empresa para prosseguir.", "Erro Seleção Empresa", JOptionPane.ERROR_MESSAGE);
        }
